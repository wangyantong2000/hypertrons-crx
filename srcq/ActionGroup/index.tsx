...
interface ActionGroupProps {
   ...
   */
  render?: (config: Array<ActionIconGroupItemType>, dropdownMenu?: Array<ActionIconGroupItemType>) => JSX.Element;
  /**
  ...
  return (
    <div className={cx(styles.content, className)} style={style}>
      ...
      {dropdownMenu && (
        ...
        >
          {dropdownMenuTrigger ? dropdownMenuTrigger : <ActionIcon icon={<DashOutlined />} key="more" size={size} />}
        </Dropdown>
      )}
    </div>
  );
