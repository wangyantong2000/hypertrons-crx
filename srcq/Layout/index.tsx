...
export type LayoutTypeEnum = 'Left&Right' | 'LeftFull' | 'RightFull' | 'Bottom' | string | null | undefined;
...
const BasicLayout = (props: LayoutProps) => {
  ...
  const pannels = [leftPannel, rightPannel, bottomPannel, centerPannel].map((props, index) => {
    ...
    return <PannelDefault key={'pannel' + index} {...props} index={index} themeType={props?.themeType || themeType} />;
  });
