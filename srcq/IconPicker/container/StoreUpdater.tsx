...
const StoreUpdater: FC<StoreUpdaterProps> = ({
  ...
  useStoreUpdater('activeIconfontScript', activeIconfontScript, [activeIconfontScript], ({ activeIconfontScript }) => {
    storeApi.getState().selectScript(activeIconfontScript);
  });
  useStoreUpdater('activeIconfontScript', defaultActiveIconfontScript, [], ({ activeIconfontScript }) => {
    storeApi.getState().selectScript(activeIconfontScript);
  });
