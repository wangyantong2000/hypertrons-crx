...
const TEST_ICON_FONT_SCRIPT1 = 'https://gw.alipayobjects.com/os/hitu-asset/artists/pro-editor/icons-1.0.0-beta.6.js';

const TEST_ICON_FONT_SCRIPT2 = 'https://gw.alipayobjects.com/os/hitu-asset/artists/pro-editor/icons-1.0.0-beta.7.js';
let originFetch;
