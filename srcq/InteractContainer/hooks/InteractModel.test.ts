...
describe('InteractModel', () => {
  it('识别到元素', () => {
    ...
    const model = new InteractModel([{ id: 'container', actions: ['hover'], selectors: ['row'] }]);
  ...
  it('指定父容器时可正常找到元素', () => {
    ...
    const model = new InteractModel([{ id: 'container', actions: ['hover'], selectors: ['test'] }], container);
  ...
  describe('findElementByStatus', () => {
    it('根据status找到相应元素', () => {
      ...
      const model = new InteractModel([{ id: 'container', actions: ['click'], selectors: ['.row'] }]);
    ...
    it('动作不匹配时也无法找到元素', () => {
      ...
      const model = new InteractModel([{ id: 'container', actions: ['click'], selectors: [] }]);
