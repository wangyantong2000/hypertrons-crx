 ...
 * 控制画布交互
 */
export const useInteraction = ({ interactModel, container, dispatchStatus, disabled }: InteractionOptions) => {
  ...
  useEffect(() => {
    ...
    const { unRegister, register } = initListener(container, 'click', onContainerClick);
