...
export const getDefaultValueFromSchema = (schema: JSONSchema) => {
  if (schema.type === 'object') {
    ...
    return Object.fromEntries(Object.entries(schema.properties).map(([key, value]) => [key, value.default]));
  }
 ...
 */
export const getSymbolMasterNameFromProps = (pkg: string, component: string, props: any, schema?: JSONSchema) => {
 ...
 * @param PropStringFn
 */
export const generateJSXCode = (component: string, props: Record<string, any>, PropStringFn = createPropString) => {
  if (!props) {
    return `<${component} />`;
  }
