...
describe('generateCode', () => {
  ...
  describe('带 children 的组件', () => {
    it('children 是纯文本', () => {
      ...
      expect(generateJSXCode('Button', props)).toEqual('<Button size="small" width={120} type="primary">文案</Button>');
    });
...
describe('generateProps', () => {
  ...
  describe('对象', () => {
    ...
    it('嵌套对象', () => {
      expect(createPropString('hello', { a: { b: { c: 23 } } })).toEqual('hello={{"a":{"b":{"c":23}}}}');
    });
    it('空对象', () => {
