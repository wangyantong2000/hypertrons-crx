...
const MenuComponent = forwardRef<HTMLButtonElement, ContextMenuProps & HTMLProps<HTMLButtonElement>>(
      ...
      <FloatingNode id={nodeId}>
        ...
        <FloatingPortal>
          {isOpen && (
            ...
            >
              <div className={styles.container} ref={refs.setFloating} style={floatingStyles} {...getFloatingProps()}>
...
const ContextMenu = forwardRef<HTMLButtonElement, ContextMenuProps & HTMLProps<HTMLButtonElement>>((props, ref) => (
  <ConfigProvider>
    <FloatingTree>
