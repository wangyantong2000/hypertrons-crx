...
export const ProBuilder: FC<ProBuilderAppProps> = memo((props) => {
  ...
  const [exportConfig, componentAsset, width, panelExpand] = useStore(
    (s) => [s.exportConfig, s.componentAsset, s.editorAwareness.panelSize.width, s.editorAwareness.panelExpand],
    shallow
  );
  ...
  const children = (
    <div className={styles.main} style={style}>
      <div className={styles.left} style={{ maxWidth: panelExpand ? `calc(100vw - ${width}px)` : '100vw' }}>
